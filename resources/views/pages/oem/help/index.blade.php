...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <section id="roles" class="scroll-mt-24 rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
        ...
        <div class="mt-4 space-y-4 text-sm text-zinc-700 dark:text-zinc-300">
            <div>
                <h3 class="font-medium text-zinc-900 dark:text-white">OEM Admin</h3>
                <p>Full access to the OEM account. Can manage team members, locations, and all bookings across the organisation. This is the top-level administrative role.</p>
            </div>
            <div>
                <h3 class="font-medium text-zinc-900 dark:text-white">OEM Planner</h3>
                <p>Can create and manage bookings, coordinate logistics, and oversee transport schedules. Has access to all bookings within the OEM organisation.</p>
            </div>
            <div>
                <h3 class="font-medium text-zinc-900 dark:text-white">OEM Viewer</h3>
                <p>Read-only access to bookings and deliveries. Useful for stakeholders who need visibility into vehicle movements without the ability to create or modify bookings.</p>
            </div>
        </div>
    </section>
    ...
    <section id="locations" class="scroll-mt-24 rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
        ...
        <div class="mt-4 space-y-3 text-sm text-zinc-700 dark:text-zinc-300">
            <p>Navigate to the <strong>Locations</strong> page to manage your organisation's pickup and delivery addresses.</p>
            ...
            <p>Locations are exclusive to your organisation and are not shared with other companies.</p>
        </div>
    </section>
    ...
    <section id="deliveries" class="scroll-mt-24 rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
        ...
        <div class="mt-4 space-y-3 text-sm text-zinc-700 dark:text-zinc-300">
            ...
            <ul class="list-disc list-inside space-y-1 pl-2">
                <li><strong>All Deliveries</strong> &ndash; Shows every booking for your organisation, regardless of who created it.</li>
