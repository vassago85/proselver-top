...
<div>
    ...
    <div class="flex justify-end mb-4">
        <a href="{{ route('dealer.bookings.create') }}" class="inline-flex items-center rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-blue-500 transition-colors">
            + New Booking
        </a>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-x-auto">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                @empty
                <tr><td colspan="5" class="px-6 py-12 text-center text-sm text-gray-500">No jobs yet. <a href="{{ route('dealer.bookings.create') }}" class="text-blue-600 hover:underline">Create your first booking</a></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
