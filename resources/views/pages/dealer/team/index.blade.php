...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    /**
     * Scope a user lookup to the current dealer's company. Without this, a
     * dealer principal at Company A could pass any user id from the client
     * and edit/deactivate users at Company B. This enforces the tenancy
     * boundary server-side regardless of what the client sent.
     */
    ...
    public function saveEdit(): void
    {
        ...
        $user->update($data);
        $company = auth()->user()->company();
        // Intersect against the dealer-tier role catalog for THIS company so
        // a tampered role id list can't escalate the target user into an
        // internal (super_admin, ops_manager, etc.) role.
        $validRoleIds = $company
