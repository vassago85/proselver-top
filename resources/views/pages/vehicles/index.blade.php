...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    public function with(): array
    {
        ...
        // Role-aware detail route. Volt::route produces either
        // admin.orders.show or oem.bookings.show — OEMs never see the
        // admin layout, ops never sees the OEM one.
        $detailRoute = ($user->isInternal() || $user->belongsToPlatformOwner())
            ? 'admin.orders.show'
            : 'oem.bookings.show';
