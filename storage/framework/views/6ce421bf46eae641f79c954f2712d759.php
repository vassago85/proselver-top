...
<div>
     <?php $__env->slot('header', null, []); ?> All Jobs <?php $__env->endSlot(); ?>
    ...
    <div class="mb-6 flex flex-col sm:flex-row gap-4">
        ...
        <select wire:model.live="status" class="rounded-lg border border-gray-300 px-4 py-2.5 text-sm">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['pending_verification','verified','approved','rejected','assigned','in_progress','completed','ready_for_invoicing','invoiced','cancelled']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 cursor-pointer" onclick="window.location='<?php echo e(route('admin.jobs.show', $job)); ?>'">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->isTransport()): ?><?php echo e($job->fromHub?->name); ?> → <?php echo e($job->toHub?->name); ?><?php else: ?> Yard <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </td>
...
<?php endif; ?></td>
                    <td class="px-6 py-4 text-sm text-gray-500"><?php echo e($job->scheduled_date?->format('d M')); ?></td>
                </tr>
...
</div><?php /**PATH /var/www/html/resources/views/pages/admin/jobs/index.blade.php ENDPATH**/ ?>